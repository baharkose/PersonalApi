...
module.exports = (req, res, next) => {
  ...
  // ! 19 - modelimizi işlemek için kullandığımız middleware, farkı bize sayma işlemi yapıyor. Örneğin eklenen personel sayısı gibi hesaplamamları yapan bir middleware. Detayları gösteren bir middleware'dır. Kaç data var. vs. vs.

  // - neden biz bunu middleware yaptık func yapmadık. Req ve rese ihtiyaç var, URL'i kullanmak için, işin içerisine eğer res, req girerse artık o bir middleware olur. Şimdi controllera depart.
